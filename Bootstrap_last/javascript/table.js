...
// let p3_1 = document.createElement("p"); //Удаление столбца
//     p3_1.classList.add("card-title");
//     p3_1.innerHTML = "Выберите номер столбца для удаления";
//     div3.appendChild(p3_1);

//     let inputNumCol = document.createElement("input");
//     inputNumCol.classList.add("form-control");
//     inputNumCol.type = "number";
//     div3.appendChild(inputNumCol);

//     let button_3_1 = document.createElement("button")
//     button_3_1.classList.add("btn", "btn-outline-primary", "mx-auto", "mt-2");;
//     button_3_1.innerHTML = "Удалить"
//     button_3.onclick = function () {
//         for (i = 0; i < mas[0]; i++){
//         if (inputNumCol.value = )
// }
//         if ((button_3_1.parentNode.querySelector("input").value < document.getElementsByTagName("tr").length) && (button_3_1.parentNode.querySelector("input").value > 0)) {
//             document.getElementsByTagName("tr")[button_3_1.parentNode.querySelector("input").value].remove()
//         } else {
//            alert("Некорректное значение");
//        }
//     }
// div3.appendChild(button_3_1);
